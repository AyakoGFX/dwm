...
static const struct arg args[] = {
    ...
    { netspeed_tx, " 󰜷 %s |", "wlp4s0" },
    { netspeed_rx, " 󰜮 %s |", "wlp4s0" },
    ...
    { run_command, " 󰕾 %s%% |", "pactl list sinks | awk '/Volume:/ {print $5}' | head -n 1 | tr -d '%'" },
    // { wifi_perc,             "   %s%% |",                  "wlp4s0" },                     // Wi-Fi signal strength wlp4s0, wlan0
};
